    ...
    this.trigs.forEach((trig) => {
      ...
      switch (trig.heading) {
        ...
        case "W":
          ...
          trig.boundIMGs.push(new OctaImage("img_W_11", img_W_00, trig.AX-(smallImgShortSide+(octaRadius*0.32))+(smallImgShortSide*0.4), trig.AY-(smallImgLongSide/2), smallImgShortSide, smallImgLongSide, trig));
          trig.boundIMGs.push(new OctaImage("img_W_22", img_W_00, trig.AX-(smallImgShortSide+(octaRadius*0.43))+(smallImgShortSide*0.4), trig.AY-(smallImgLongSide/2), smallImgShortSide, smallImgLongSide, trig));
          anchorX = (trig.AX+trig.BX)/2;
          anchorY = (trig.AY+trig.BY)/2;
          trig.boundIMGs.push(new OctaImage("img_W_t0", img_W_00, anchorX-(smallImgLongSide*1.1), anchorY+(smallImgShortSide*0.1), smallImgLongSide, smallImgShortSide, trig));
          trig.boundIMGs.push(new OctaImage("img_W_t1", img_W_00, anchorX-(smallImgShortSide*3.1), anchorY-(smallImgLongSide*0.5), smallImgShortSide, smallImgLongSide, trig));
          trig.boundIMGs.push(new OctaImage("img_W_t2", img_W_00, anchorX-(smallImgShortSide*4.8), anchorY-(smallImgLongSide*1.1), smallImgShortSide, smallImgLongSide, trig));
          anchorX = (trig.AX+trig.CX)/2;
          anchorY = (trig.AY+trig.CY)/2;
          trig.boundIMGs.push(new OctaImage("img_W_b0", img_W_00, anchorX-(smallImgLongSide*1.1), anchorY-(smallImgShortSide*1.1), smallImgLongSide, smallImgShortSide, trig));
          trig.boundIMGs.push(new OctaImage("img_W_b1", img_W_00, anchorX-(smallImgShortSide*3.1), anchorY-(smallImgLongSide*0.5), smallImgShortSide, smallImgLongSide, trig));
          trig.boundIMGs.push(new OctaImage("img_W_b2", img_W_00, anchorX-(smallImgShortSide*4.8), anchorY, smallImgShortSide, smallImgLongSide, trig));
          trig.boundIMGs.push(new OctaImage("img_W_m0", img_W_00, trig.AX-(smallImgLongSide*5.05), trig.AY-(smallImgShortSide/2), smallImgLongSide, smallImgShortSide, trig));
          trig.boundIMGs.push(new OctaImage("img_W_m1", img_W_00, trig.AX-(smallImgLongSide*6.5), trig.AY-(smallImgLongSide/2), smallImgLongSide, smallImgLongSide, trig));
          trig.boundIMGs.push(new OctaImage("img_W_mt", img_W_00, trig.AX-(octaRadius*0.98), trig.AY-(smallImgLongSide*1.2), smallImgShortSide, smallImgLongSide, trig));
          trig.boundIMGs.push(new OctaImage("img_W_mb", img_W_00, trig.AX-(octaRadius*0.98), trig.AY+(smallImgLongSide*0.2), smallImgShortSide, smallImgLongSide, trig));
          break;
        case "NE":
